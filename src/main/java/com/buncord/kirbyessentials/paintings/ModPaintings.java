...
public class ModPaintings {
    ...
    public static final RegistryObject<Motive> BRIONY_NYEHEHE = registerPainting("briony_nyehehe",16,16);
    public static final RegistryObject<Motive> KORT_PEEP = registerPainting("kort_peep",32,32);
    public static final RegistryObject<Motive> THE_SILLIES = registerPainting("the_sillies",64,48);
