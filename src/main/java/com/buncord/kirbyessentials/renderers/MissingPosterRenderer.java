...
public class MissingPosterRenderer extends EntityRenderer<MissingPosterEntity> {
  ...
  public void render(
      @NotNull MissingPosterEntity entity,
      float direction,
      float partialTick,
      PoseStack poseStack,
    ...
    TextureAtlasSprite missingPosterFrontSprite = textureAtlas.getSprite(
        new ResourceLocation(
            KirbyEssentials.MOD_ID,
            MISSING_POSTER_SPRITE_PATH
        )
    );

    TextureAtlasSprite missingPosterBackSprite = textureAtlas.getSprite(
    ...
    this.renderPainting(
        ...
        width,
        height,
        missingPosterFrontSprite,
        missingPosterBackSprite
    );
    poseStack.popPose();
  ...
  @Override
  public @NotNull ResourceLocation getTextureLocation(@NotNull MissingPosterEntity entity) {
  ...
  private void renderPainting(
      ...
      MissingPosterEntity entity,
      int width,
      int height,
      TextureAtlasSprite missingPosterFrontSprite,
      TextureAtlasSprite missingPosterBackSprite
  ) {
...
//    float f2 = 0.5F;
    float f3 = missingPosterBackSprite.getU0();
    float f4 = missingPosterBackSprite.getU1();
    float f5 = missingPosterBackSprite.getV0();
    float f6 = missingPosterBackSprite.getV1();
    float f7 = missingPosterBackSprite.getU0();
    float f8 = missingPosterBackSprite.getU1();
    float f9 = missingPosterBackSprite.getV0();
    float f10 = missingPosterBackSprite.getV(1.0D);
    float f11 = missingPosterBackSprite.getU0();
    float f12 = missingPosterBackSprite.getU(1.0D);
    float f13 = missingPosterBackSprite.getV0();
    float f14 = missingPosterBackSprite.getV1();
    int i = width / 16;
    int j = height / 16;
    ...
    for(int k = 0; k < i; ++k) {
      for(int l = 0; l < j; ++l) {
        ...
        float f19 = missingPosterFrontSprite.getU(d0 * (double)(i - k));
        float f20 = missingPosterFrontSprite.getU(d0 * (double)(i - (k + 1)));
        float f21 = missingPosterFrontSprite.getV(d1 * (double)(j - l));
        float f22 = missingPosterFrontSprite.getV(d1 * (double)(j - (l + 1)));
