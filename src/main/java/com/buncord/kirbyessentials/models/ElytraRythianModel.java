...
@OnlyIn(Dist.CLIENT)
public class ElytraRythianModel<T extends LivingEntity> extends AgeableListModel<T>  {
  public static final ModelLayerLocation LAYER_LOCATION =
      new ModelLayerLocation(
          new ResourceLocation(KirbyEssentials.MOD_ID, "elytra_rythian"),
          "main"
      );
  ...
  public ElytraRythianModel(ModelPart modelPart) {
  ...
  public static LayerDefinition createLayer() {
    ...
    return LayerDefinition.create(meshdefinition, 40, 31);
  }
