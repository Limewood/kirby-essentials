...
@OnlyIn(Dist.CLIENT)
public class BnuyHatModel<T extends LivingEntity> extends CosmeticArmorModel<T> {

  public static final ModelLayerLocation LAYER_LOCATION =
      new ModelLayerLocation(
          new ResourceLocation(KirbyEssentials.MOD_ID, "bnuy_hat"),
          "main"
      );

  private static final ResourceLocation TEXTURE = new ResourceLocation(
      KirbyEssentials.MOD_ID,
      "textures/models/armor/bnuy_hat.png"
  );
  ...
  public BnuyHatModel(ModelPart modelPart) {
    super(modelPart);
